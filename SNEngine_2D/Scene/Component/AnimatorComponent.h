...
public:
	...
	void SetCurrentFrameNumber(const uint& number) { this->current_frame_number; }
	...
	auto AddAnimation(const std::string& animation_name, std::shared_ptr<class Animation>& animation);
